namespace TriTracker.Web.DataContexts.ApplicationMigrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.ActivitySegments",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Distance = c.Decimal(nullable: false, precision: 18, scale: 2),
                        TimeTaken = c.Decimal(nullable: false, precision: 18, scale: 2),
                        StartCoordinates = c.String(),
                        EndCoordinates = c.String(),
                        Activity_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Activities", "Race_Id", "dbo.Races");
            DropForeignKey("dbo.Activities", "Athlete_Id", "dbo.Athletes");
            DropForeignKey("dbo.ActivitySegments", "Activity_Id", "dbo.Activities");
            ...
            DropIndex("dbo.ActivitySegments", new[] { "Activity_Id" });
            DropIndex("dbo.Activities", new[] { "Race_Id" });
            DropIndex("dbo.Activities", new[] { "Athlete_Id" });
            ...
            DropTable("dbo.ActivitySegments");
