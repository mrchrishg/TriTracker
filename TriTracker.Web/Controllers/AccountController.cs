    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await CreateAthleteRecord(user, model);
                    ...
                    //Change this to redirect to create Atlete record
        ...
        private async Task<int> CreateAthleteRecord(ApplicationUser user, dynamic model)
        {
